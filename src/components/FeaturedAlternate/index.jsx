...
const projects = [
  {
    ...
    description:"<p>Developed a fully functional blog website using ReactJS for the frontend and AppWrite for the backend.Implemented user authentication, post creation, editing, and deletion, as well as comment management functionalities.Integrated React Redux for efficient state management across the application.Leveraged AppWrite for managing user authentication, data storage, and API interactions, ensuring a secure and efficient platform.</p>"

    ,    
    websiteLink: "https://blogwebsite-orpin.vercel.app/",
    // techno
    html: true,
    css: true,
    javascript: true,
  ...
  {
    id: 2,
    image: images.yourlogo ,
    heading: "Your Logo ",
    description:
      "</p>I have developed a sample website utilizing React.js and Tailwind CSS. This project showcases my proficiency in modern front-end technologies, emphasizing a component-based architecture with React.js and the utility-first approach of Tailwind CSS for streamlined and responsive design.</p>",
    websiteLink: "https://sampleyourlogo.vercel.app/",  
    // techno
    html: true,
    css: true,
    javascript: true,
  ...
  {
    id: 3,
    image: images.themeswitch,
    heading: "Theme Switcher",
    description:
      "<p>I have developed a theme switcher using React.js and Tailwind CSS. This project includes a toggle button that allows users to seamlessly switch between themes, demonstrating my skills in implementing dynamic and responsive user interfaces with modern front-end technologies.</p>",
    websiteLink: "https://themeswitcher-alpha.vercel.app/",
    // techno
    html: true,
    css: true,
    javascript: true,
  ...
  },
  {
    ...
    heading: "Titanic-Survival-Ananlysis",
    description:
      "<p>Developed a predictive model using supervised machine learning algorithms in Python to determine passenger survival on the Titanic.Conducted extensive data preprocessing and feature engineering to enhance model performance.Applied machine learning techniques that including logistic regression to identify the most accurate model.</p>",

    websiteLink: "https://github.com/MANTVI/Titanic-Survival-Ananlysis/blob/main/Titanic.ipynb",  
